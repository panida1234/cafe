...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="http://localhost:8080/cafe/assets/css/flaticon.css" />

        <!-- Animate -->
        <link rel="stylesheet" href="http://localhost:8080/cafe/assets/css/animate.css">
        <!-- Bootsnav -->
        <link rel="stylesheet" href="http://localhost:8080/cafe/assets/css/bootsnav.css">
        <!-- Color style -->
        <link rel="stylesheet" href="http://localhost:8080/cafe/assets/css/color.css">

        <!-- Custom stylesheet -->
        <link rel="stylesheet" href="http://localhost:8080/cafe/assets/css/custom.css" />
        <!--[if lt IE 9]>
        ...
        <nav class="navbar navbar-default bootsnav no-background navbar-fixed black">
            <div class="container">  
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#"><img src="http://localhost:8080/cafe/assets/images/logo_1.png" class="logo" alt=""></a>
                </div>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="banner">
                            ...
                            <div class="inner_banner">
                                ...
                                <div class="stamp">
                                    <img src="http://localhost:8080/cafe/assets/images/stamp.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="block">
            <div class="container">
                    ...
                    <div class="col-sm-8">
                        <div class="feature">
                            <div class="shack_burger">
                                <div class="chicken">
                                    <img src="http://localhost:8080/cafe/assets/images/chicken.png" alt="Chicken" />
                                </div>
                        ...
                        <div id="small_carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="http://localhost:8080/cafe/assets/images/small_slider_bg.jpg" alt="" />
                                </div>
                                <div class="item">
                                    <img src="http://localhost:8080/cafe/assets/images/small_slider_bg.jpg" alt="" />
                                </div>
                ...
                <div id="carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="http://localhost:8080/cafe/assets/images/large_slider_img.jpg" alt="Burger">
...
<br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4 col-xs-12 pull-right">
                        <div class="basic_info">
                            <a href=""><img class="footer_logo" src="http://localhost:8080/cafe/assets/images/logo_1.png" alt="Burger" /></a>
        ...
        <!-- Bootsnav js -->
        <script src="http://localhost:8080/cafe/assets/js/bootsnav.js"></script>

        <!-- JS Implementing Plugins -->
        <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
        <script src="http://localhost:8080/cafe/assets/js/gmaps.min.js"></script>


        <!--main js-->
        <script type="text/javascript" src="http://localhost:8080/cafe/assets/js/main.js"></script>
    </body>	
</html>	