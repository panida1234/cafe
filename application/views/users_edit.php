                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                      <a href="editedit_1/<?php echo $r['id']; ?>"><button type="submit" class="btn btn-primary">แก้ไข</button></a></td>
                     <td> <?php echo anchor("cafe/delete/".$r['id'],"ลบ",array("class"=>"btn btn-primary","onclick" =>" return confirm('Are you sure?');")); ?> </td>
                        </td> </th>
